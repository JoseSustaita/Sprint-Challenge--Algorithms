class SortingRobot:
    ...
    def sort(self):
        ...
        # If robot cannot move right, list is sorted
        ...
        while True:
            # Traverse to the last item in the list, swapping till robot is holding smallest item
            while self.can_move_right():
                self.move_right()
                if self.compare_item() == 1:
                    self.swap_item()
            # End of list, holding smallest item
